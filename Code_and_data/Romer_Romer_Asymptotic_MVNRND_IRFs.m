...
% intervals for every response and horizon.
...
plot_scale_newm_com = [100; 100; 100; 1];
...
panel_indices_newm_com = [4, 1, 2, 3];
...
plot_scale_ff_com = [100; 100; 100; 1];
...
pointwise_std_table_ff_com = array2table( ...
    ...
    'VariableNames', {'Horizon', 'Output', 'PriceLevel', ...
    'CommodityPrices', 'FederalFundsRate'});
